...
**Date:** 2026-02-21 22:17:17

## Technique Description


This experiment uses **xlm-roberta-base**, a transformer-based model fine-tuned for multi-label manifestation classification.
...
- **Subset Accuracy (Exact Match):** 0.5625
- **Hamming Loss:** 0.1719
- **F1 Score (Micro):** 0.3580
- **F1 Score (Macro):** 0.1831
- **F1 Score (Weighted):** 0.2578
- **F1 Score (Samples):** 0.1131
- **Jaccard Score (Micro):** 0.2180
- **Jaccard Score (Macro):** 0.1269
...
### Overall Performance
- **Micro F1 Score:** 0.3580 (overall performance across all manifestations)
- **Macro F1 Score:** 0.1831 (average performance per manifestation)
- **Subset Accuracy:** 0.5625 (exact match - all manifestations correct)
- **Hamming Loss:** 0.1719 (fraction of incorrect manifestation predictions)
- **Jaccard Score (Micro):** 0.2180 (overlap between predictions and truth)
...
**Most Challenging Manifestation:** Stereotype
- F1 Score: 0.0000
- Precision: 0.0000
- Recall: 0.0000
...
**Performance Range:**
- F1 scores range from 0.0000 to 0.6047
...
- Micro F1 score of 0.3580 (overall performance across all labels)
- Macro F1 score of 0.1831 (average performance per label)
- Subset accuracy of 0.5625 (exact match ratio)
